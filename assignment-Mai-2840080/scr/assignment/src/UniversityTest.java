 ...
 * as you go.
 * 
 * UniversityTest also contains the following incomplete test methods that 
...
public class UniversityTest {
	...
	public void loadData() {
		...
		Professor[] prof_list = new Professor[]{ new Professor("Alek Sib", 159, "aleksib@stir.ac.uk"),
	...
	public void go() {
    	...
    	System.out.println("\n-Showing Insertion Sort descending name--");
		...
		if (bsn != null) 
		 ...
		 StringBuilder  sBuffer = new StringBuilder ("Student CSV:");
		
		 for(int i=0; i<5; i++){
				
			 sBuffer.append(stirling.inWalk(i));
        }
		System.out.println( stirling.toString());
	...
	public void inOrderTest() {	
		...
		assertEquals(stirling.inWalk(0), "John J,Alma A,Kate K,Loius L,");
		System.out.println("\n--In Order Walk--\n" + stirling.toString());
	}
	...
	public void binarySearchTest() {	
		...
		// Now conduct an assertion test...
		assertEquals(stirling.binarySearch("Algorithms 3").toString(),"Module: 8764 - Algorithms 3 -- Students: Borba B,Jess Z,Hugh J,Jess Z,");
		assertEquals(stirling.binarySearch("Biology 1"), null);
	...
	public void findTest() {
		assertNull(stirling.find(0, "John J"));
